...
namespace TareasMVC.Controllers
{
    public class UsuariosController : Controller
    {
            ...
            string remoteError = null)
        {
            ...
            var resultadoLooginExterno = await signInManager.ExternalLoginSignInAsync(info.LoginProvider,
                info.ProviderKey, isPersistent: true, bypassTwoFactor: true);

            //ya la cuenta existe
            if (resultadoLooginExterno.Succeeded)
            {
            ...
            {
                mensaje = "Error leyendo el email del usuario del ";
                return RedirectToAction("login", routeValues: new { mensaje });
            }
